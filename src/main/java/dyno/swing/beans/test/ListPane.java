...
public class ListPane extends JPanel {
    ...
    private static final long serialVersionUID = 6438197707588889989L;
    ...
    public void addItem(String text, String iconURL){
        ...
        if(iconURL!=null){
            lblItem.setIcon(new ImageIcon(Thread.class.getResource(iconURL)));
    ...
    class MyBorder extends LineBorder{
        private static final long serialVersionUID = -3955345129651979044L;
